...
package com.intland.codebeamer.integration.testcase.classic.tracker.main;
...
public class TrackersPageTestCases extends AbstractIntegrationClassicNGTests {
	...
	public void checkTrackerInTrackerTree() {
		...
		Tracker tracker = trackerApiService
				...
				.createBooleanField("My Boolean", builder -> builder.mandatory(true))
				.createDateField("My Date field", builder -> builder.displayYear(true).displayMonth(true))
				.buildAndAdd();
