...
@Test(groups = "ProjectMembersPageTestCases")
public class ProjectMembersPageTestCases extends AbstractIntegrationClassicNGTests {
	...
	@Test(description = "Add role option is available on project members page")
	public void testAddRoleOptionIsAvailable() {
		// When / Then
		getClassicCodebeamerApplication(user)
				.visitProjectMembersPage(project)
				.assertProjectMembersActionBarComponent(ProjectMembersActionBarAssertion::isReady);
	}

	@Test(description = "User is able to add role")
	public void testAddRole() {
		// When / Then
		getClassicCodebeamerApplication(user)
				.visitProjectMembersPage(project)
				.getProjectMembersActionBarComponent()
				.addRole()
				.redirectedToEditRolePage();
	}
}
