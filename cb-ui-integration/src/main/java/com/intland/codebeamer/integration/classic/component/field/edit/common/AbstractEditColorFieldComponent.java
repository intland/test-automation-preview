...
public abstract class AbstractEditColorFieldComponent<C extends AbstractEditColorFieldComponent<C, A>, A extends AbstractEditColorFieldAssertions<C, A>>
		extends AbstractEditFieldComponent<C, A> {

	public AbstractEditColorFieldComponent(CodebeamerPage codebeamerPage, String frameLocator, String componentLocator) {
