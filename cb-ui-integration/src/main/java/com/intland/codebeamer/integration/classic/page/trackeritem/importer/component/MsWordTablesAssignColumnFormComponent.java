...
public class MsWordTablesAssignColumnFormComponent
		extends AssignColumnFormComponent<MsWordTablesAssignColumnFormComponent, MsWordTablesAssignColumnFormAssertions> {

	public MsWordTablesAssignColumnFormComponent(CodebeamerPage page) {
		super(page);
	}

	@Override
	public MsWordTablesAssignColumnFormAssertions assertThat() {
		return new MsWordTablesAssignColumnFormAssertions(this);
	}

	public MsWordTablesAssignColumnFormComponent fillStartImportAtRow(int start) {
	 ...
	 *              </ul>
	 */
	public MsWordTablesAssignColumnFormComponent selectDataHierarchyBasedOnColumn(String index) {
