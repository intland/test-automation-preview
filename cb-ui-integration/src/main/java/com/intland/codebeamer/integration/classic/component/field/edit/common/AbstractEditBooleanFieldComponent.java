...
public abstract class AbstractEditBooleanFieldComponent<C extends AbstractEditBooleanFieldComponent<C, A>, A extends AbstractEditBooleanFieldAssertions<C, A>>
		extends AbstractEditFieldComponent<C, A> {

	public AbstractEditBooleanFieldComponent(CodebeamerPage codebeamerPage, String frameLocator, String componentLocator) {
