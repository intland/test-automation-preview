...
public class MsExcelAssignColumnFormAssertions
		extends AssignColumnFormAssertions<MsExcelAssignColumnFormComponent, MsExcelAssignColumnFormAssertions> {

	protected MsExcelAssignColumnFormAssertions(MsExcelAssignColumnFormComponent component) {
		super(component);
	}

	public MsExcelAssignColumnFormAssertions isStartImportAtRow(int row) {
	 ...
	 *              </ul>
	 */
	public MsExcelAssignColumnFormAssertions isDataHierarchyBasedOnColumn(String index) {
