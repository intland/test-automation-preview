...
package com.intland.codebeamer.integration.classic.page.user.component.actionbar.dashboard;
...
public class UserDashboardActionbarComponent extends AbstractWikiDashboardActionbarComponent {
	...
	@Override
	public UserDashboardActionbarAssertion assertThat() {
		return new UserDashboardActionbarAssertion(this);
	}
